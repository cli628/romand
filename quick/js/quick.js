document.addEventListener('DOMContentLoaded', () => {
    ...
    function initColorSelection() {
        const swatches = document.querySelectorAll('.color_swatches li');
        ...
        swatches.forEach(li => {
            const btn = li.querySelector('.swatch');
            if (!btn) return;
