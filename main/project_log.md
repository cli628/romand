...
| 기록 방식 | 계획/적용 내용은 `project_log.md`에 누적 |
...
## [완료] new_section 그라디언트 배경 이미지 적용 (2026-03-29)

### 목표
`new_section`의 봉투 이미지(`.shopping_bag_container`) 뒤쪽 살짝 위에 `img/new_gra.png`를 배경으로 배치

### 변경 내용
- `test/main/index.html` — `.shopping_bag_container` 안에 `.new_gra_bg` div 추가
- `test/main/css/main.css` — `.new_gra_bg` 스타일 추가

### z-index 레이어 구조
| 레이어 | z-index | 설명 |
|--------|---------|------|
| `.new_gra_bg` | 0 | 그라디언트 배경 (가장 뒤) |
| `.bag_back` | 1 | 봉투 뒷면 |
| `.floating_products` (floating_item) | 2 | 제품 이미지 |
| `.bag_front` | 3 | 봉투 앞면 |
...
| 2026-03-29 | new_section 그라디언트 배경(new_gra.png) 적용 완료 |
| 2026-03-29 | skill.md → project_log.md 파일명 변경 |

---

## 다음 작업 대기 항목

- [x] **new_gra.png 배경 적용** — 완료 (2026-03-29)
